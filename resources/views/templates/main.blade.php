...
<html lang="en">
  <head>
    ...
    <title>Z-Store</title>
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="img/logozstore.png" type="image/png">
    <!-- Bootstrap CSS -->
  ...
  <body>
    ...
    <header id="home" class="hero-area">    
      ...
      <nav class="navbar navbar-expand-md bg-inverse fixed-top scrolling-navbar">
        <div class="container">
          <a href="index.html" class="navbar-brand"><img src="img/logozstore.png" alt=""></a>       
      ...
      <div class="container">      
        <div class="row space-100">
          <div class="col-lg-6 col-md-12 col-xs-12">
            <div class="contents">
              <h2 class="head-title">Zstore Beauty<br>Flawless Perfection</h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12 pl-4">
            <div class="business-item-info">
              <h3>Zstore: Aplikasi Kecantikan untuk Pengalaman Belanja Lebih Mudah</h3>
              <p>Dapatkan pengalaman belanja yang lebih mudah dan praktis dengan mengunduh aplikasi Zstore di perangkat Android Anda. 
                Menyediakan berbagai produk kecantikan terkini dan terbaik, aplikasi kami dirancang untuk memenuhi kebutuhan dan keinginan Anda dalam perjalanan kecantikan Anda. Jelajahi koleksi produk terbaru, temukan penawaran menarik, dan nikmati kemudahan berbelanja langsung dari ponsel Anda. </p>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-2 col-md-5 col-xs-12 mt-3">
            <div class="single-team">
              <div class="team-thumb">
                <img src="img/team/arya.jpeg" class="img-fluid" alt="">
              </div>
          ...
          <div class="col-lg-2 col-md-5 col-xs-12 mt-3">
            <div class="single-team">
              <div class="team-thumb">
                <img src="img/team/ibnu.jpeg" class="img-fluid" alt="">
              </div>
          ...
          <div class="col-lg-2 col-md-5 col-xs-12 mt-3">
            <div class="single-team">
              <div class="team-thumb">
                <img src="img/team/putri.jpeg" class="img-fluid" alt="">
              </div>
            ...
            <div class="col-lg-2 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              <div class="widget">
                ...
                <ul class="menu">
                  ...
                  <li style="color:white">- Why Zstore?</a></li>
                </ul>
              </div>
            </div>
             <!-- End Col -->
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="site-info text-center">
                  <p>Developed by Annisa Nurul Nabilah</p>
                </div>              
